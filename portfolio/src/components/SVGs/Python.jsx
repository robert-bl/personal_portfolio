export default function PythonIcon ({dimensions}) {
    return (
        <div className="icon-wrapper">
            <svg viewBox="0 0 128 128" width={dimensions} height={dimensions}>
            ...
            <radialGradient id="python-original-c" cx="1825.678" cy="444.45" r="26.743" gradientTransform="matrix(0 -.24 -1.055 0 532.979 557.576)" gradientUnits="userSpaceOnUse"><stop offset="0" stopColor="#B8B8B8" stopOpacity=".498"></stop><stop offset="1" stopColor="#7F7F7F" stopOpacity="0"></stop></radialGradient>
