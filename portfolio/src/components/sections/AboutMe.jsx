export default function AboutMe () {
    ...
    return (
        <div>
            <div id='about-me' className="h-10"></div>
            <div className='bg-lit sm:w-full md:w-4/5 mx-auto mt-12 border-t-4 border-b-4 border-medgry'>
                ...
                <div className="bg-drkgry p-4 my-4 mx-4">
                ...
                <div className="bg-drkgry text-center p-4 m-4">I am a software engineer who brings over a decade of experience in logistics and project management from the brewing and outdoor education fields. I am passionate about improving outcomes and user's experiences by building complex systems using thorough, collaborative, detail oriented approaches.</div>
            </div>
        </div>
    )
}