    ...
    return (
        <div>
            ...
            <div className='bg-lit sm:w-full md:w-4/5 mx-auto mt-12 p-4 border-t-4 border-medgry'>
                <div className="bg-white text-drkgry p-4 my-4">
                ...
                <div className="bg-prof bg-cover bg-center sm:w-3/5 md:w-2/5 mx-auto aspect-square rounded-full border"></div>
                <div className="bg-white text-drkgry p-4 my-4">I am a brewer turned software engineer with over a decade of experience in logistics and project management in the fields of craft brewing and outdoor education. I am passionate about improving outcomes and user's experiences by building complex systems using thorough, collaborative, detail oriented approaches.</div>
            </div>
        </div>
    )
}